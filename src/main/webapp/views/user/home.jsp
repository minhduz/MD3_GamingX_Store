                ...
                <div class="header__nav">
                    <nav class="header__menu mobile-menu">
                        <ul>
                            ...
                            <li><a href="<%=request.getContextPath()%>/FollowingServlet">Following</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
    ...
    <div class="container">
        <div class="hero__slider owl-carousel">
            <c:forEach items="${listBanner}" var="bn">
                <div class="hero__items set-bg" data-setbg="<%=request.getContextPath()%>/images/${bn.bannerImage}">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="hero__text">
                                <h2>${bn.bannerTitle}</h2>
                                <p>${bn.bannerContent}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="trending__product">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="btn__all">
                                <a href="<%=request.getContextPath()%>/GameHomeServlet" class="primary-btn">View All <span class="arrow_right"></span></a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <c:forEach items="${listTrending}" var="ta">
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    <a href="<%=request.getContextPath()%>/GameDetailServlet?gameID=${ta.gameID}">
                                        <div class="product__item__pic set-bg" data-setbg="<%=request.getContextPath()%>/images/${ta.gameMainImage}">
                                            <div class="view">${ta.gamePrice}$</div>
                                        </div>
                                        <div class="product__item__text">
                                            <h5><a href="#">${ta.gameName}</a></h5>
                                        </div>
                                    </a>
                                </div>
                            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Check Out Successfully</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                Your order has been successfully paid. Please check your email to receive the game key in the next few days.
            </div>
