...
<section class="normal-breadcrumb set-bg" data-setbg="<%=request.getContextPath()%>/views/user/img/spider_man.jpg">
  <div class="container">
    <div class="row">
    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        <div class="login__register">
          ...
          <a href="<%=request.getContextPath()%>/SignUpServlet" class="primary-btn">Register Now</a>
        </div>
      </div>
    </div>
