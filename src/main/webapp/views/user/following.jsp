    ...
    <div class="row">
      <div class="col-lg-8">
        <div class="trending__product">
          ...
          <div class="row">
            <c:forEach items="${listFollowing}" var="lf">
              <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="product__item">
                  <a href="<%=request.getContextPath()%>/GameDetailServlet?gameID=${lf.gameID}">
                    <div class="product__item__pic set-bg" data-setbg="<%=request.getContextPath()%>/images/${lf.gameMainImage}">
                      <div class="view">${lf.gamePrice}$</div>
                    </div>
                    <div class="product__item__text">
                      <h5><a href="#">${lf.gameName}</a></h5>
                    </div>
                  </a>
                </div>
              </div>
