...
<section class="normal-breadcrumb set-bg" data-setbg="<%=request.getContextPath()%>/views/user/img/elden_ring.jpg">
    <div class="container">
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="login__form">
                    <h3>Sign Up</h3>
                    <form action="<%=request.getContextPath()%>/UserServlet?action=Create" method="post" enctype="multipart/form-data">
                        <div class="input__item">
                            <input type="text" placeholder="Username" name="userName">
                            <span class="icon_profile"></span>
                        </div>
                        <div class="input__item">
                            <input type="password" placeholder="Password" name="userPassword" id="usPassword">
                            <span class="icon_lock"></span>
                        </div>
                        <div class="input__item">
                            <input type="password" placeholder="Confirm password" name="userConfirmPassword" id="usConfirmPassword">
                            <span id="lock" class="icon_lock"></span>
                        </div>
                        <div class="input__item">
                            <input type="text" placeholder="Full Name" name="userFullName">
                            <span><i class="fa-regular fa-user"></i></span>
                        </div>
                        <div class="input__item">
                            <input id="input_file" type="file" name="userAvatar">
                    ...
                    <h5>Already have an account? <a href="<%=request.getContextPath()%>/LoginServlet">Log In!</a></h5>
                </div>
            </div>
            <div class="col-lg-6">
