...
<section class="h-100 h-custom" style="background-color: #0b0c2a;">
      ...
      <div class="col">
        <div class="card">
          <div class="card-body p-4">
            <div class="row">
              <div class="col-lg-12">
                <h5 class="mb-3"><a href="<%=request.getContextPath()%>/GameHomeServlet" class="text-body"><i
                        class="fas fa-long-arrow-alt-left me-2"></i>Continue shopping</a></h5>
                <hr>
                <div class="d-flex justify-content-between align-items-center mb-4">
                  <div>
                    <p class="mb-1">Shopping cart</p>
                    <p class="mb-0">You have ${sessionScope.totalCarts} items in your cart</p>
                  </div>
                  <div>
                    <p class="mb-0">
                      <span class="text-muted">Sort by:</span>
                      <a href="#" class="text-body">price <i class="bi bi-caret-down-fill"></i></a>
                    </p>
                  </div>
                </div>
                    ...
                    <div class="card-body">
                      <div class="d-flex justify-content-between">
                        <div class="d-flex flex-row align-items-center">
                          <div>
                            <img src="<%=request.getContextPath()%>/images/${ca.game.gameMainImage}" class="img-fluid rounded-3" alt="Shopping item" style="width: 65px; height: 90px; border-radius: 6px">
                          </div>
                          <div class="ms-3">
                            <h5 style="margin-left: 40px">${ca.game.gameName}</h5>
                          </div>
                        </div>
                        <div class="d-flex flex-row align-items-center">
                          <div style="width: 50px;">
                            <h5 class="fw-normal mb-0">${ca.quantity}</h5>
                          </div>
                          <div style="width: 80px;">
                            <h5 class="mb-0">$${ca.quantity*ca.game.gamePrice*(100-ca.game.gameDiscount)/100}</h5>
                          </div>
                          <a href="<%=request.getContextPath()%>/ShoppingCartServlet?action=Delete&&gameName=${ca.game.gameName}" style="color: #cecece;"><i class="fas fa-trash-alt"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <button style="display: ${cko!=null?"none":""};" type="button" class="btn btn-info btn-block btn-lg"
                        onclick="window.location.href='<%=request.getContextPath()%>/OrderServlet?action=CheckOut';">
                  <div class="d-flex justify-content-between">
