                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td scope="col">${order.orderUserName}</td>
                                    <td scope="col">${order.orderUserEmail}</td>
                                    <td scope="col">${order.orderDate}</td>
                                    <td scope="col">${order.orderTotalAmount}$</td>
                                    <td scope="col">${order.orderStatus?"Payment":"Unpayment"}</td>
                                    <td scope="col">
                                        <button type="button" class="btn btn-outline-warning m-2" onclick="window.location.href='<%=request.getContextPath()%>/OrderServlet';">Back To All</button>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                    ...
                    <div class="bg-secondary rounded h-100 p-4">
                        ...
                        <table class="table">
                            ...
                            <c:forEach items="${listOrderDetail}" var="od">
                                <tr>
                                    <th>${od.orderDetailGameID}</th>
                                    <td>
                                        <img id="trending" src="<%=request.getContextPath()%>/images/${od.orderDetailMainImage}" alt="">
                                    </td>
                                    <td>${od.orderDetailGameName}</td>
                                    <td>${od.orderDetailGamePrice}$</td>
                                    <td>${od.orderDetailGameDiscount}%</td>
                                    <td>${od.orderDetailQuantity}</td>
                                    <td>${od.orderDetailAmount}$</td>
                                </tr>
                            </c:forEach>
                            <tr>
                                <th></th>
