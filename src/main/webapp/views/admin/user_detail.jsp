    ...
    <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-secondary navbar-dark">
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="<%=request.getContextPath()%>/GameServlet?action=GetAll" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Games</a>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td scope="col">${us.userPassword}</td>
                                        <th scope="col">${us.userStatus?"Active":"Inactive"}</th>
                                        <td scope="col">
                                            <button type="button" class="btn btn-outline-warning m-2"
                                                    onclick="window.location.href='<%=request.getContextPath()%>/UserServlet?action=GetAll';">Back To All</button>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Following: </th>
                                        <td scope="col" colspan="4">${us.userFollowing}
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>${us.userPhone}</td>
                                    <td>${us.userEmail}</td>
                                    <td>${us.userPermission?"Admin":"User"}</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
